defmodule Poller.Auth.AuthTest do
    ...
    test "Should Hash the users raw password" do
        changeset = %Poller.Auth.User{}
        |> Poller.Auth.User.new_changeset(%{username: "Srinidhi", email: "sriprabandham@gmail.com", password: "password"})
    ...
    test "should validate length of password to be a minimum of 8" do
        changeset = %Poller.Auth.User{}
        |> Poller.Auth.User.new_changeset(%{username: "Srinidhi", email: "sriprabandham@gmail.com", password: "test"})
